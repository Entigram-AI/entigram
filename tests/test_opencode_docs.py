...
class TestOpenCodeDocs(unittest.TestCase):
    def test_opencode_doc_recommends_mcp_boundary(self):
        ...
        self.assertIn("OpenCode Desktop cannot find `etg`", doc)
        self.assertIn("Desktop apps on macOS", doc)
        self.assertIn("command -v etg", doc)
        self.assertIn("/Users/you/path/to/etg", doc)
        self.assertIn("/Users/dnyabuti/Documents/workspace/entigram/.venv/bin/etg", doc)
    ...
    def test_opencode_example_config_keeps_entigram_enabled(self):
        ...
        self.assertIn("OpenCode Desktop may not inherit your shell PATH", config)
        self.assertIn("command -v etg", config)
