...
def get_hydration_vector(
    ...
    agent_configuration_present = bool(
        manifest.get("cli_engine") or manifest.get("agent_governance")
    )
    if agent_configuration_present:
        from entigram.workspace_lifecycle import (
            active_agent_adapter_status,
        ...
        adapter_status = {
            ...
            "active_agents": [],
            "agents": {},
            "next_action": "Configure a workspace agent before governed agent operations.",
        }
...
def _main():
    ...
    # Experimental feature: no command surface unless explicitly enabled.
    if os.environ.get("ENTIGRAM_ENABLE_MODEL_ROUTING") == "1":
